...
describe("SURA AI-commerce safeguards", () => {
  ...
  it("keeps delivery estimates transparent when origin and destination differ", () => {
    ...
    expect(calculateDeliveryEstimate("Nairobi", "Nakuru")).toMatchObject({ distanceBand: "regional", deliveryKes: 750 });
    expect(calculateDeliveryEstimate("Nakuru", "Nakuru County")).toMatchObject({ distanceBand: "same_city", deliveryKes: 450 });
  });
